...
As its heart, this project produces an SQLite database that provides access to all the data that exists in GitHub Discussions, GitHub Issues, and GitHub Pull Requests.
